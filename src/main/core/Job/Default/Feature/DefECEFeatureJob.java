 ...
 */
public class DefECEFeatureJob implements TaskJob {
    ...
    public boolean startJob(String optionsValue)
        ...
        consoleLog.info("featureNum : "+featureNumStr);

        String aggreateOutPath = outputPath + "/aggreateECEModel";
...
//        int clazzNum = 3;
        ...
        Path eceTmp = new Path(hdfsTmpPath, "eceTmp");
...
//            统计单个类中的termsNum和clazzTermRatio
    ...
    static class ECESortReducer
        ...
        protected void cleanup(Context context)
            ...
            context.write(new Text("ECEFeatreu"), featureModel);
            super.cleanup(context);
        }
    }
}
